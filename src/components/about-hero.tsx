        ...
        <AnimatePresence>
          <FadeUp key="title-greeting" duration={0.6}>
            <h1 className="text-6xl font-bold text-accent sm:text-7xl md:text-6xl lg:text-5xl xl:text-7xl">
              Hi, I&apos;m Umer Mehboob Khan
            </h1>
          </FadeUp>
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              I transform ideas into high-performance web applications. With
              expertise in building scalable, user-focused solutions, I ensure
              clean code, seamless user experiences, and maintainable
              architectures across every project.
            </p>
          </FadeUp>
          ...
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              ...
              to see how I leverage modern technologies like{" "}
              ...
              to build responsive, dynamic, and feature-rich web applications.
            </p>
          </FadeUp>
